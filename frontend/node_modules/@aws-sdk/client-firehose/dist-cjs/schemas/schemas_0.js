...
const { ConcurrentModificationException, InvalidArgumentException, InvalidKMSResourceException, InvalidSourceException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ServiceUnavailableException } = require("../models/errors");
const { FirehoseServiceException } = require("../models/FirehoseServiceException");
const _s_registry = TypeRegistry.for(_s);
const FirehoseServiceException$ = [-3, _s, "FirehoseServiceException", 0, [], []];
...
const InvalidKMSResourceException$ = [-3, n0, _IKMSRE,
    { [_e]: _c },
    [_co, _m],
    [0, 0]
];
...
const InvalidSourceException$ = [-3, n0, _ISE,
    { [_e]: _c },
    [_co, _m],
    [0, 0]
];
...
const AmazonOpenSearchServerlessBufferingHints$ = [3, n0, _AOSSBH,
    0,
    [_IIS, _SIMB],
    [1, 1]
];
exports.AmazonOpenSearchServerlessBufferingHints$ = AmazonOpenSearchServerlessBufferingHints$;
const AmazonOpenSearchServerlessDestinationConfiguration$ = [3, n0, _AOSSDC,
    0,
...
const AmazonOpenSearchServerlessDestinationDescription$ = [3, n0, _AOSSDD,
    0,
...
const AmazonOpenSearchServerlessDestinationUpdate$ = [3, n0, _AOSSDU,
    0,
...
const AmazonOpenSearchServerlessRetryOptions$ = [3, n0, _AOSSRO,
    0,
    [_DIS],
    [1]
];
exports.AmazonOpenSearchServerlessRetryOptions$ = AmazonOpenSearchServerlessRetryOptions$;
const AmazonopensearchserviceBufferingHints$ = [3, n0, _ABH,
    0,
    [_IIS, _SIMB],
    [1, 1]
];
exports.AmazonopensearchserviceBufferingHints$ = AmazonopensearchserviceBufferingHints$;
const AmazonopensearchserviceDestinationConfiguration$ = [3, n0, _ADC,
    0,
...
const AmazonopensearchserviceDestinationDescription$ = [3, n0, _ADD,
    0,
...
const AmazonopensearchserviceDestinationUpdate$ = [3, n0, _ADU,
    0,
...
const AmazonopensearchserviceRetryOptions$ = [3, n0, _ARO,
    0,
    [_DIS],
    [1]
];
...
const BufferingHints$ = [3, n0, _BH,
    0,
    [_SIMB, _IIS],
    [1, 1]
];
exports.BufferingHints$ = BufferingHints$;
const CatalogConfiguration$ = [3, n0, _CC,
    0,
    [_CARN, _WL],
    [0, 0]
];
exports.CatalogConfiguration$ = CatalogConfiguration$;
const CloudWatchLoggingOptions$ = [3, n0, _CWLO,
    0,
    [_E, _LGN, _LSN],
    [2, 0, 0]
];
exports.CloudWatchLoggingOptions$ = CloudWatchLoggingOptions$;
const CopyCommand$ = [3, n0, _CCo,
    0,
    [_DTN, _DTC, _CO],
    [0, 0, 0], 1
];
exports.CopyCommand$ = CopyCommand$;
const CreateDeliveryStreamInput$ = [3, n0, _CDSI,
    0,
...
const DatabaseSourceDescription$ = [3, n0, _DSD,
    0,
...
const DatabaseSourceVPCConfiguration$ = [3, n0, _DSVPCC,
    0,
    [_VESN],
    [0], 1
];
exports.DatabaseSourceVPCConfiguration$ = DatabaseSourceVPCConfiguration$;
const DatabaseTableList$ = [3, n0, _DTL,
    0,
    [_I, _Ex],
    [64 | 0, 64 | 0]
];
exports.DatabaseTableList$ = DatabaseTableList$;
const DataFormatConversionConfiguration$ = [3, n0, _DFCC,
    0,
    [_SCc, _IFC, _OFC, _E],
...
const DeleteDeliveryStreamInput$ = [3, n0, _DDSI,
    0,
    [_DSN, _AFD],
    [0, 2], 1
];
exports.DeleteDeliveryStreamInput$ = DeleteDeliveryStreamInput$;
const DeleteDeliveryStreamOutput$ = [3, n0, _DDSO,
    0,
    [],
    []
];
exports.DeleteDeliveryStreamOutput$ = DeleteDeliveryStreamOutput$;
const DeliveryStreamDescription$ = [3, n0, _DSDe,
    0,
...
const ElasticsearchDestinationDescription$ = [3, n0, _EDD,
    0,
    [_RARN, _DARN, _CEl, _IN, _TN, _IRP, _BH, _RO, _SBM, _SDD, _PC, _CWLO, _VCD, _DIO],
...
const ElasticsearchDestinationUpdate$ = [3, n0, _EDU,
    0,
    [_RARN, _DARN, _CEl, _IN, _TN, _IRP, _BH, _RO, _SUp, _PC, _CWLO, _DIO],
...
const ElasticsearchRetryOptions$ = [3, n0, _ERO,
    0,
    [_DIS],
    [1]
];
...
const ExtendedS3DestinationConfiguration$ = [3, n0, _ESDC,
    0,
...
const ExtendedS3DestinationDescription$ = [3, n0, _ESDD,
    0,
...
const ExtendedS3DestinationUpdate$ = [3, n0, _ESDU,
    0,
...
const FailureDescription$ = [3, n0, _FD,
    0,
    [_Ty, _Det],
    [0, 0], 2
];
exports.FailureDescription$ = FailureDescription$;
const HiveJsonSerDe$ = [3, n0, _HJSD,
    0,
    [_TF],
    [64 | 0]
];
exports.HiveJsonSerDe$ = HiveJsonSerDe$;
const HttpEndpointBufferingHints$ = [3, n0, _HEBH,
    0,
    [_SIMB, _IIS],
    [1, 1]
];
exports.HttpEndpointBufferingHints$ = HttpEndpointBufferingHints$;
const HttpEndpointCommonAttribute$ = [3, n0, _HECA,
    0,
    [_AN, _AV],
...
const HttpEndpointDestinationDescription$ = [3, n0, _HEDD,
    0,
...
const HttpEndpointDestinationUpdate$ = [3, n0, _HEDU,
    0,
...
const IcebergDestinationDescription$ = [3, n0, _IDD,
    0,
...
const IcebergDestinationUpdate$ = [3, n0, _IDU,
    0,
...
const RedshiftDestinationConfiguration$ = [3, n0, _RDC,
    0,
...
const RedshiftDestinationDescription$ = [3, n0, _RDD,
    0,
...
const RedshiftDestinationUpdate$ = [3, n0, _RDU,
    0,
...
const RedshiftRetryOptions$ = [3, n0, _RRO,
    0,
    [_DIS],
    [1]
];
exports.RedshiftRetryOptions$ = RedshiftRetryOptions$;
const RetryOptions$ = [3, n0, _RO,
    0,
    [_DIS],
    [1]
];
exports.RetryOptions$ = RetryOptions$;
const S3DestinationConfiguration$ = [3, n0, _SDC,
    0,
...
const S3DestinationDescription$ = [3, n0, _SDD,
    0,
...
const SnowflakeDestinationDescription$ = [3, n0, _SDDn,
    0,
...
const SnowflakeDestinationUpdate$ = [3, n0, _SDUn,
    0,
...
const SplunkBufferingHints$ = [3, n0, _SBHp,
    0,
    [_IIS, _SIMB],
    [1, 1]
];
exports.SplunkBufferingHints$ = SplunkBufferingHints$;
const SplunkDestinationConfiguration$ = [3, n0, _SDCp,
    0,
...
const SplunkDestinationDescription$ = [3, n0, _SDDp,
    0,
...
const SplunkDestinationUpdate$ = [3, n0, _SDUp,
    0,
...
const SplunkRetryOptions$ = [3, n0, _SROp,
    0,
    [_DIS],
    [1]
];
exports.SplunkRetryOptions$ = SplunkRetryOptions$;
const StartDeliveryStreamEncryptionInput$ = [3, n0, _SDSEI,
    0,
    [_DSN, _DSECI],
...
const UpdateDestinationOutput$ = [3, n0, _UDO,
    0,
    [],
    []
];
...
const VpcConfigurationDescription$ = [3, n0, _VCD,
    0,
