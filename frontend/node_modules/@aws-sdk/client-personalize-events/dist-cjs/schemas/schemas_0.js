...
const { InvalidInputException, ResourceInUseException, ResourceNotFoundException } = require("../models/errors");
const { PersonalizeEventsServiceException } = require("../models/PersonalizeEventsServiceException");
const _s_registry = TypeRegistry.for(_s);
const PersonalizeEventsServiceException$ = [-3, _s, "PersonalizeEventsServiceException", 0, [], []];
...
const ActionInteraction$ = [3, n0, _AIc,
    0,
...
const PutItemsRequest$ = [3, n0, _PIR,
    0,
    [_dA, _it],
    [0, [() => ItemList, 0]], 2
];
exports.PutItemsRequest$ = PutItemsRequest$;
const PutUsersRequest$ = [3, n0, _PUR,
    0,
    [_dA, _u],
    [0, [() => UserList, 0]], 2
];
