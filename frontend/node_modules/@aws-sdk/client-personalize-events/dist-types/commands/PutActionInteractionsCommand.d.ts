...
declare const PutActionInteractionsCommand_base: {
    new (input: PutActionInteractionsCommandInput): import("@smithy/core/client").CommandImpl<PutActionInteractionsCommandInput, PutActionInteractionsCommandOutput, PersonalizeEventsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutActionInteractionsCommandInput): import("@smithy/core/client").CommandImpl<PutActionInteractionsCommandInput, PutActionInteractionsCommandOutput, PersonalizeEventsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
